...
const Company = () => {
    ...
    const {fetchCompany,isLoading} = useFetchCompany(setSelectedCompany,setCompanyPrograms)
    ...
    return(
      ...
      <Stack p={20}>
        ...
        <CompanyPrograms companyPrograms={companyPrograms} setProgress={setProgress}/>
      </Stack>
      </>
